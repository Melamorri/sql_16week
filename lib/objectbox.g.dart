...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 5346074331650346814),
      name: 'Note',
      lastPropertyId: const IdUid(3, 127583743080185532),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 3129056971373950559),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 6926154804563939902),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 127583743080185532),
            name: 'description',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 5346074331650346814),
